...
class VideoTweet(object):
    ...
    def upload_init(self):
        ...
        req = requests.post(
            url=self.MEDIA_ENDPOINT_URL, data=request_data, auth=self.oauth)
    ...
    def tweet(self, status):
		...
		'''
        request_data = {'status': status, 'media_ids': self.media_id}
...
twit = Twitter(TWIT_CONSUMER_TOKEN, TWIT_CONSUMER_SECRET, TWIT_ACCESS_TOKEN,
